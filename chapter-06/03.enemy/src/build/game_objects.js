...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'build/game_objects.data';
  ...
  Module['FS_createPath']('/', 'sprites', true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_build/game_objects.data');

      };
      Module['addRunDependency']('datafile_build/game_objects.data');
   ...
   loadPackage({"files": [{"filename": "/sprites/FranchiseExplosion7.png", "start": 0, "end": 155, "audio": 0}, {"filename": "/sprites/FranchiseExplosion6.png", "start": 155, "end": 473, "audio": 0}, {"filename": "/sprites/Franchise1.png", "start": 473, "end": 3628, "audio": 0}, {"filename": "/sprites/Franchise3.png", "start": 3628, "end": 6802, "audio": 0}, {"filename": "/sprites/FranchiseExplosion4.png", "start": 6802, "end": 7426, "audio": 0}, {"filename": "/sprites/BirdOfAnger.png", "start": 7426, "end": 7801, "audio": 0}, {"filename": "/sprites/FranchiseExplosion5.png", "start": 7801, "end": 8309, "audio": 0}, {"filename": "/sprites/Franchise2.png", "start": 8309, "end": 11484, "audio": 0}, {"filename": "/sprites/FranchiseExplosion1.png", "start": 11484, "end": 11866, "audio": 0}, {"filename": "/sprites/FranchiseExplosion2.png", "start": 11866, "end": 12366, "audio": 0}, {"filename": "/sprites/FranchiseExplosion3.png", "start": 12366, "end": 12979, "audio": 0}, {"filename": "/sprites/Franchise4.png", "start": 12979, "end": 16142, "audio": 0}, {"filename": "/sprites/Projectile.png", "start": 16142, "end": 16288, "audio": 0}, {"filename": "/sprites/FranchiseExplosion8.png", "start": 16288, "end": 16410, "audio": 0}, {"filename": "/sprites/Franchise.png", "start": 16410, "end": 19565, "audio": 0}], "remote_package_size": 19565, "package_uuid": "5d928972-1bd9-4df9-a142-727317893613"});
...
var ASM_CONSTS = {
 ...
 39315: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 40304: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 40397: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 41622: function() {return screen.width;},  
 41649: function() {return screen.height;},  
 41677: function() {return window.innerWidth;},  
 41709: function() {return window.innerHeight;},  
 41787: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 41921: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 42087: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
